<!-- Header-->
<header class="py-5 d-none" id="hero_content">
            ...
            <div class="col-xxl-7">
                ...
                <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                    <div class="profile bg-gradient-primary-to-secondary">
                        ...
                        <img class="profile-img" id="image" src="{{ asset('frontend/assets/profile.png') }}" />
                        <div class="dots-1">
                            <!-- SVG Dots-->
